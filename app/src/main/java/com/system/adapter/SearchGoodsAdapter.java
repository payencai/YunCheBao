 ...
 * 邮箱：771548229@qq..com
 */
public class SearchGoodsAdapter extends BaseQuickAdapter<GoodList, BaseViewHolder> {
    public SearchGoodsAdapter(int layoutResId, @Nullable List<GoodList> data) {
    ...
    protected void convert(BaseViewHolder helper, GoodList item) {
        ...
        tv_name.setText(item.getName()+" "+item.getFirstName()+" " +item.getSecondName());
