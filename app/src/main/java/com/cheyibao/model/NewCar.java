...
public class NewCar implements Serializable{
    ...
    /**
     * advicePrice : 0
     * carCategoryDetail : {"advicePrice":0,"banner1":"string","banner2":"string","banner3":"string","carCategoryId":"string","country":"string","createTime":"2019-01-06T16:20:20.753Z","displacement":"string","fuel":"string","id":"string","models":"string","param":[{"belong":"string","carCategoryDetailId":"string","createTime":"2019-01-06T16:20:20.753Z","id":"string","param":[null],"paramName":"string","paramValue":"string"}],"remark":"string","sales":0,"seat":"string","variableBox":"string"}
     * carCategoryDetailId : string
     * color : string
     * createTime : 2019-01-06T16:20:20.753Z
     * firstId : string
     * firstName : string
     * id : string
     * isDel : 0
    ...
    public static class CarCategoryDetailBean implements Serializable{
         ...
         * id : string
         * models : string
         * param : [{"belong":"string","carCategoryDetailId":"string","createTime":"2019-01-06T16:20:20.753Z","id":"string","param":[null],"paramName":"string","paramValue":"string"}]
         * remark : string
         * sales : 0
         * seat : string
         * variableBox : string
