...
public class OnSaleCarDetailConfigActivity extends NoHttpBaseActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.on_sale_car_config_layout);
        initView();
    }
    ...
    public void OnClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.askLowPriceBtn:
                ActivityAnimationUtils.commonTransition(OnSaleCarDetailConfigActivity.this, AskLowPriceActivity.class, ActivityConstans.Animation.FADE);
                break;
