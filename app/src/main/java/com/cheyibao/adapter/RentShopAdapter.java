...
public class RentShopAdapter extends BaseQuickAdapter<RentShop,RentShopAdapter.ViewHolder> {

    public RentShopAdapter(@Nullable List<RentShop> data) {
        super(R.layout.item_rentcar, data);
    }

    @Override
    protected void convert(ViewHolder helper, RentShop item) {
