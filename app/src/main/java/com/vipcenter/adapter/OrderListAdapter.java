...
//                            .setUri(PlatformContans.root +entity.getPic())
//                            .setAutoPlayAnimations(true)
//                            .build();
//                    vh.img.setController(controller);
//                }
//                vh.name.setText(entity.getName());
//                vh.price.setText("￥" + Double.parseDouble(entity.getPrice())/100);
//                vh.num.setText("x" + entity.getNum());
                break;
            case 3:// foot
//                if (entity.getNum() != null && !entity.getNum().equals("")) {
//                    vh.totalNum.setText("共" + entity.getNum() + "件商品  合计：￥");
//                } else {
//                    vh.totalNum.setText("共x件商品  合计：￥");
//                }
//                vh.totalPrice.setText("" + Double.parseDouble(entity.getPrice())/100);
