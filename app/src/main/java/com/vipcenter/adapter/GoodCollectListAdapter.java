...
public class GoodCollectListAdapter extends BaseAdapter {
    ...
    public GoodCollectListAdapter(Context ctx, List<PhoneGoodEntity> list) {
        this.list = list;
        this.ctx = ctx;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            vh = new ViewHolder();
            convertView = LayoutInflater.from(ctx).inflate(R.layout.good_collect_list_item_layout, null);
