...
public class NewPublish {
    ...
    /**
     * audit : 0
     * carCategoryDetail : {"advicePrice":0,"banner1":"string","banner2":"string","banner3":"string","carCategoryId":"string","country":"string","createTime":"2019-01-28T08:38:24.837Z","displacement":"string","fuel":"string","id":"string","models":"string","param":[{"belong":"string","carCategoryDetailId":"string","createTime":"2019-01-28T08:38:24.837Z","id":"string","param":[null],"paramName":"string","paramValue":"string"}],"remark":"string","sales":0,"seat":"string","variableBox":"string"}
     ...
     * change : 0
     * color : string
     * createTime : 2019-01-28T08:38:24.837Z
     * distance : string
     * firstId : string
     * firstName : string
     * id : string
     ...
     * isDel : 0
     * lastValidateCar : 2019-01-28T08:38:24.837Z
     * linkman : string
     ...
     * registrationTime : 2019-01-28T08:38:24.837Z
     * rejectReason : string
     * secondId : string
     * secondName : string
     * state : 0
    ...
    public static class CarCategoryDetailBean {
         ...
         * id : string
         * models : string
         * param : [{"belong":"string","carCategoryDetailId":"string","createTime":"2019-01-28T08:38:24.837Z","id":"string","param":[null],"paramName":"string","paramValue":"string"}]
         * remark : string
         * sales : 0
         * seat : string
         * variableBox : string
