...
import com.chat.domain.InviteMessage.InviteMessageStatus;
import com.chat.domain.RobotUser;
...
//        });
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                Intent intent = new Intent(appContext, CustomServiceActivity.class);
