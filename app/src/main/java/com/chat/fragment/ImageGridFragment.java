...
import com.chat.domain.VideoEntity;
import com.chat.ui.RecorderVideoActivity;
import com.chat.util.ImageCache;
import com.chat.util.ImageResizer;
import com.chat.util.Utils;
import com.chat.widget.RecyclingImageView;
import com.example.yunchebao.BuildConfig;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mImageResizer.setLoadingImage(R.mipmap.default_img);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (position == 0) {
                ...
                holder.imageView.setImageResource(R.mipmap.camera_default);
            } else {
