...
public class ReplaceOrder implements Serializable{
    ...
    /**
     * agencyId : string
     * createTime : 2019-04-15T02:34:39.702Z
     * driverHeadPortrait : string
     * driverId : string
     * driverName : string
     ...
     * endLongitude : string
     * handleState : 0
     * handleTime : 2019-04-15T02:34:39.702Z
     * id : string
     * isComment : 0
     * name : string
     * orderNo : string
     * payMethod : 0
     * payTime : 2019-04-15T02:34:39.702Z
     * price : 0.0
     * shopId : string
     * shopLogo : string
     * shopName : string
    ...
    public void setDriverHeadPortrait(String driverHeadPortrait) {
