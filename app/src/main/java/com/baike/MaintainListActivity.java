...
import com.baike.fragment.MaintainMenuFragment;
...
public class MaintainListActivity extends NoHttpFragmentBaseActivity {
...
//        }
    ...
    private void initView() {
        UIControlUtils.UITextControlsUtils.setUIText(findViewById(R.id.title), ActivityConstans.UITag.TEXT_VIEW,"养护百科");
        //网络地址获取轮播图
        imageList.clear();
        for (int i = 0; i < 3; i++) {
...
//            image_uri.put("imageUris", adList.get(i).getCid());
    ...
    private void setViewPager() {
        MaintainMenuFragment goodsFragment1=new MaintainMenuFragment();
        MaintainMenuFragment goodsFragment2=new MaintainMenuFragment();
        MaintainMenuFragment goodsFragment3=new MaintainMenuFragment();

        mFragments.add(goodsFragment1);
        mFragments.add(goodsFragment2);
        mFragments.add(goodsFragment3);
