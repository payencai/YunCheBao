...
public class DriverDetailActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        HttpProxy.obtain().get(PlatformContans.SubstituteDriving.getSubstituteDriverByDriverId, params, new ICallBack() {
            @Override
            public void OnSuccess(String result) {
                Log.e("shopDetail", result);
                try {
    ...
    private void setData() {
        ...
        try {
            ...
            Date driveday =format.parse(mCoachDetail.getDrivingAge() + " 00:00:00");
            int age = getAgeByBirth(bithday) - 1;
            int driveage=getAgeByBirth(driveday);
            String value = mCoachDetail.getSex() + " " + age + "岁 " + mCoachDetail.getConstellation() + " 驾龄" + driveage + "年";
    ...
    private void apply(String reason, final Dialog dialog) {
        Map<String, Object> params = new HashMap<>();
        params.put("shopId", mCoachDetail.getShopId());
            ...
            public void OnSuccess(String result) {
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        tv_add.setText("开始聊天");
                        dialog.dismiss();
                        Toast.makeText(DriverDetailActivity.this, "已添加对方为好友！开始进行聊天吧~", Toast.LENGTH_SHORT).show();
                    } else {
                        ToastUtil.showToast(DriverDetailActivity.this, msg);
                    }
    ...
    private void initBanner() {
        ...
        banner.setImageLoader(new com.youth.banner.loader.ImageLoader() {
            ...
            public void displayImage(Context context, Object path, ImageView imageView) {
                ...
                Glide.with(DriverDetailActivity.this).load((String) path).into(imageView);
            }
        });
