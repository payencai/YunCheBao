...
import com.example.yunchebao.sidebar.indexablerv.database.HeaderFooterDataObservable;
import com.example.yunchebao.sidebar.indexablerv.database.HeaderFooterDataObserver;
import com.example.yunchebao.sidebar.indexablerv.database.IndexBarDataObservable;
import com.example.yunchebao.sidebar.indexablerv.database.IndexBarDataObserver;
...
abstract class AbstractHeaderFooterAdapter<T> {
    ...
    public abstract void onBindContentViewHolder(RecyclerView.ViewHolder holder, T entity,List<Object> payloads);
