...
import com.example.yunchebao.sidebar.indexablerv.database.DataObservable;
import com.example.yunchebao.sidebar.indexablerv.database.DataObserver;
...
public abstract class IndexableAdapter<T extends IndexableEntity> {
    ...
    public abstract void onBindTitleViewHolder(RecyclerView.ViewHolder holder, String indexTitle, List<Object> payloads);
...
//        mDataSetObservable.notifyChanged();
    ...
    public void notifyItemChange(int pos){
        mDataSetObservable.notifyItem(pos);
    }
