...
public class SimpleHeaderAdapter<T extends IndexableEntity> extends IndexableHeaderAdapter<T> {
    ...
    @Override
    public void onBindContentViewHolder(RecyclerView.ViewHolder holder, T entity, List<Object> payloads) {
        mAdapter.onBindContentViewHolder(holder, entity,payloads);
    }
