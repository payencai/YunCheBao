...
/**
 * 作者：凌涛 on 2019/4/18 16:47
 * 邮箱：771548229@qq..com
 */
public class FourShopCar {

    /**
     * advicePrice : 0.0
     * carCategoryDetail : {"advicePrice":0,"banner1":"string","banner2":"string","banner3":"string","carCategoryId":"string","country":"string","createTime":"2019-04-18T08:47:05.251Z","displacement":"string","fuel":"string","id":"string","models":"string","param":[{"belong":"string","carCategoryDetailId":"string","createTime":"2019-04-18T08:47:05.251Z","id":"string","param":[null],"paramName":"string","paramValue":"string"}],"remark":"string","sales":0,"seat":"string","variableBox":"string"}
     * carCategoryDetailId : string
     * color : string
     * createTime : 2019-04-18T08:47:05.251Z
     * firstId : string
     * firstName : string
     * id : string
     * nakedCarPrice : 0.0
    ...
    public static class CarCategoryDetailBean {
         ...
         * id : string
         * models : string
         * param : [{"belong":"string","carCategoryDetailId":"string","createTime":"2019-04-18T08:47:05.251Z","id":"string","param":[null],"paramName":"string","paramValue":"string"}]
         * remark : string
         * sales : 0
         * seat : string
         * variableBox : string
