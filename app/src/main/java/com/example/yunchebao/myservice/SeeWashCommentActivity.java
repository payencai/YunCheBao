...
public class SeeWashCommentActivity extends AppCompatActivity {
    ...
    String id;
    WashOrderComment mWashOrderComment;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_see_wash_comment);
        ...
        HttpProxy.obtain().get(PlatformContans.CarWashRepairShop.getWashRepairOrderCommentByOrderId, params, MyApplication.token,new ICallBack() {
            ...
            public void OnSuccess(String result) {
                ...
                try {
                    ...
                    mWashOrderComment = new Gson().fromJson(data.toString(), WashOrderComment.class);
                    setData();
        ...
        gv_shopphoto.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                PictureConfig config = new PictureConfig.Builder()
                        ...
                        .build();
                config.gotoActivity(SeeWashCommentActivity.this, config);
