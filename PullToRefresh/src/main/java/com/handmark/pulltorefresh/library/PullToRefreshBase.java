...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private RefreshStartListener refreshStartListener;
                ...
                if (isReadyForPull()) {
                    ...
                    switch (getPullToRefreshScrollDirection()) {
                        ...
                        default:
                            ...
                            if(refreshStartListener!=null){
                                refreshStartListener.startRefresh();
                            }
    ...
    public abstract Orientation getPullToRefreshScrollDirection();
     ...
     void setState(State state, final boolean... params) {
        mState = state;
        if (DEBUG) {
            Log.e(LOG_TAG, "State2222: " + mState.name());
        }
    ...
    protected LoadingLayout createFooterLoadingLayout(Context context, Mode mode, TypedArray attrs) {
        LoadingLayout layout = mLoadingAnimationStyle.createFooterLoadingLayout(context, mode,
                getPullToRefreshScrollDirection(), attrs);
        layout.setVisibility(View.INVISIBLE);
        return layout;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mFooterLayout = createFooterLoadingLayout(context, Mode.PULL_FROM_END, a);
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createFooterLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                case ROTATE:
                default:
                    return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
  ...
  public   static interface RefreshStartListener {
        /**
         * 开始下拉
         */
        void startRefresh();
    ...
    public void setRefreshStartListener(RefreshStartListener refreshStartListener) {
